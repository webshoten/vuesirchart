                    ...
                    <div class="jumbotron p-2">
                        <h1>SIRモデルのシミュレーション</h1>
                            ...
                            <ul>
                                ...
                                <li>$$\frac{dI(t)}{dt} =  \beta S(t) I(t) - \gamma I(t) $$ </li>
                            ...
                            <ol>
                                <li>人口を1万人とする</li>
                                <li>本SIRモデルにおける感染率 ※接触者数、感染率は、1日1人あたり$$\beta = \frac{(接触者数) \times (感染率)}{人口}$$ </li>
                                <li>本SIRモデルにおける回復率$$\gamma = \frac{1}{(回復までの日数)}$$ </li>
                        ...
                        <v-footer padless>
                           <v-col
                            ...
                            >
                             ...
                             <h6>[参考5]:SIRモデルとは https://ja.wikipedia.org/wiki/SIR%E3%83%A2%E3%83%87%E3%83%AB </h6>
                            </v-col>
                            <v-col
                            class="text-center"
                            cols="12"
    ...
    methods: {
        ...
        SIR() {
            ...
            for(this.t=0;this.t<this.tmax;this.t+=this.dt) {
                 ...
                 k2.push(this.dt*this.f1(this.t+this.dt/2.0,this.s+k1[0]/2.0,this.i+k1[1]/2.0,this.r+k1[2]/2.0,beta,gamma))
                 k2.push(this.dt*this.f2(this.t+this.dt/2.0,this.s+k1[0]/2.0,this.i+k1[1]/2.0,this.r+k1[2]/2.0,beta,gamma))
                 k2.push(this.dt*this.f3(this.t+this.dt/2.0,this.s+k1[0]/2.0,this.i+k1[1]/2.0,this.r+k1[2]/2.0,beta,gamma))

                 k3.push(this.dt*this.f1(this.t+this.dt/2.0,this.s+k2[0]/2.0,this.i+k2[1]/2.0,this.r+k2[2]/2.0,beta,gamma))
                 k3.push(this.dt*this.f2(this.t+this.dt/2.0,this.s+k2[0]/2.0,this.i+k2[1]/2.0,this.r+k2[2]/2.0,beta,gamma))
                 k3.push(this.dt*this.f3(this.t+this.dt/2.0,this.s+k2[0]/2.0,this.i+k2[1]/2.0,this.r+k2[2]/2.0,beta,gamma))

                 k4.push(this.dt*this.f1(this.t+this.dt,this.s+k3[0],this.i+k3[1],this.r+k3[2],beta,gamma))
                 k4.push(this.dt*this.f2(this.t+this.dt,this.s+k3[0],this.i+k3[1],this.r+k3[2],beta,gamma))
                 k4.push(this.dt*this.f3(this.t+this.dt,this.s+k3[0],this.i+k3[1],this.r+k3[2],beta,gamma))
